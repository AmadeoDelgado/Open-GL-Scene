...
GLuint example::Shader::compile_shaders()
{
...
void example::Shader::show_compilation_error(GLuint shader_id)
{
	string info_log;
...
void example::Shader::show_linkage_error(GLuint program_id)
{
